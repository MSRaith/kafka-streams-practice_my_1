...
public class SUMAlertsApp {
    ...
    public static final String PURCHASES_WITH_JOINED_PRODUCT_TOPIC = "purchase_with_joined_product-processor";
    public static final String RESULT_TOPIC = "amount_alerts-processor";
    public static final double MAX_PURCHASES_PER_MINUTE = 3000D;
    ...
    public static Properties getStreamsConfig() {
        ...
        props.put(StreamsConfig.APPLICATION_ID_CONFIG, "ProductSumProcessorAPI");
    ...
    public static Topology buildTopology(SchemaRegistryClient client, Map<String, String> serDeConfig) {
        ...
        topology.addSource(
                ...
                PURCHASES_WITH_JOINED_PRODUCT_TOPIC
        );
